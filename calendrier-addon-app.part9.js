="calTo">Au</label>
      ...
      <div class="cal-legend" title="Couleurs des compétitions">
        <span class="lg-ligue">Championnat</span>
        <span class="lg-c1">C1 UEFA</span>
        <span class="lg-c3">C3 UEFA</span>
        <span class="lg-c4">C4 UEFA</span>
        <span class="lg-cn">CN coupe nat.</span>
      </div>
